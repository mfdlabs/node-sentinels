...
/*
	File Name: trip_reason_authority_base.ts
	Description: Base class for trip reason authorities.
 ...
 */
export default abstract class TripReasonAuthorityBase<TExecutionContext>
  implements ITripReasonAuthority<TExecutionContext>
{
  /**
   ...
   */
  public abstract isReasonForTrip(executionContext: TExecutionContext, error: Error): boolean;
}
